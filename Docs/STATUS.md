...
| G1 KIT-READY | `PASS` | `4327491` 双 Kit/ZIP、四 verifier、双 operator bundle 与 fresh handoff 已闭合；仅为 A 环境离线证据 |
...
本地 Git 路径为 `artifacts/b28-discovery/bundles/bundle-95bce28983237f5d84d0cbfd/`；CURRENT 固定 canonical
provenance SHA-256 `95bce28983237f5d84d0cbfd1aadc762f93948a84f16364359f2ebd002f170ba`。active ledger captured-at
为 `2026-07-16T15:52:25Z`，只激活 `handoff-07bbe55bc7552489cd55`，并撤回三份旧 handoff。bundle 内含 Kit ZIP、
collector pyz、哈希、handoff、教程和 sanitized offline receipts；完整构建记录见
`Docs/process/2026-07-16-environment-reproducibility-refresh.md`。

只有最终 delivery clone、远端同步、目标机重新下载且 fresh control 仍通过后，B28 才可能按新 bundle quick-start
